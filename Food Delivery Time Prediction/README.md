...
This project uses **historical delivery data** and features such as **distance, preparation time, delivery person age, rating, order type, and vehicle type** to predict delivery times. The results are presented in an **interactive dashboard** built with Streamlit.  
